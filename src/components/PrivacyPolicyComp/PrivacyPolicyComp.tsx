        ...
        <section className="py-12">
            <div className='max-w-screen-lg mx-auto px-3'>
                <div className="space-y-8">
                    ...
                    >
                        <h5 className='font-bold text-gray-600 mb-4'>Privacy Policy</h5>
                        <p>In the below write-up, “we” or “us” or “our” refers to <strong>Niotech Smart Solutions Ltd.</strong> and “you” refers to the consumer or the site visitor. The Privacy Policy are liable to be changed without any prior notice and it is the responsibility of the user to stay updated with changes if any.</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: "easeOut" }}
                    >
                        <h5 className='font-bold text-gray-600 mb-4'>Information Gathering, Use and Sharing</h5>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: "easeOut" }}
                    >
                        <h5 className='font-bold text-gray-600 mb-4'>Security</h5>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: "easeOut" }}
                    >
                        <h5 className='font-bold text-gray-600 mb-4'>Cookies and Links</h5>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: "easeOut" }}
                    >
                        <h5 className='font-bold text-gray-600 mb-4'>Updates</h5>
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.6, ease: "easeOut" }}
                    >
                        <strong className='text-gray-600'>Last Updated On: 31th December, 2023</strong>
                    </motion.div>
                </div>
            </div>
        </section>
