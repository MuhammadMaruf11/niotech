...
const Consultancy = () => {
    return (
        <>
            <h5>
                <span className='text-[#e9b021]'>Consultancy</span>
                <img className='float-left max-w-96 me-4 mb-4' src="/img/services/Consultancy.jpg" alt="consultancy" />
            </h5>
            <div className="space-y-4 mt-4">
                ...
                <p>Heating, cooling and ventilation control allows fully climate controlled zones, minimising energy usage in your property and improves your comfort.</p>
