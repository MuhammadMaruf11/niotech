...
interface FooterProps {
    footerContactsData: { url: string; icon: string; title: string }[];
    footerServicesData: { url: string; title: string }[];
    footerSocialsData: { url: string; icon: string; title: string }[];
}

const FooterContent: FC<FooterProps> = ({ footerContactsData, footerServicesData, footerSocialsData }) => {
    return (
